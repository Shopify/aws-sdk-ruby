...
module Aws
  module S3
    ...
    # module Types
    #   autoload :ListObjectVersionsOutput, 'aws-sdk-s3/customizations/types/list_object_versions_output'
    #   autoload :PermanentRedirect, 'aws-sdk-s3/customizations/types/permanent_redirect'
    # end
  end
end
